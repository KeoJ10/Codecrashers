...
$katanas =  [181 => ['naam' => 'katana', 'description' => 'Samurai sword that randomly inflicts stun.', 'price' => 70, 'strength' => 10, 'element' => '', 'status' => 'stun 25%' ],
            ...
            184 => ['naam'=>'Muramasa', 'description' =>  'Samurai sword that randomly inflicts confuse.', 'price' => 2100, 'strength' => 80, '', 'status' =>  'confuse 10%'],
            606 => ['naam'=>'Stunner', 'description' =>  'Samurai sword that often inflicts stun.', 'price' => 'n/a', 'strength' => 90, '', 'status' =>  'stun 50%'],
            ...
            foreach($katanas as $key => $newarray) {
                echo "<article id = '".$key."'> <h1>" . $newarray['naam'] . "</h1><br> ";
                echo "<section><strong>".$newarray['description']. "</section></span> ";
                echo "<section>".$newarray['price']. "<section>";
                echo "<section>".$newarray['strength']. "</section>";
                echo "<section>".$newarray['status']. "</section></article>";
            }
?>
<html>
    <head>
